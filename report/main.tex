...
% ---------------- named colours (xcolor already loaded above) ----------
...
\author{%
  Jingwen Chen\quad Jingtao Wang\quad Shouyu Wang\\[2pt]
  {\small Rice University}\\[1pt]
  {\small\texttt{\{jc380,\,jw306,\,sw188\}@rice.edu}}%
}
...
% ---- Figure 2: Per-method coloured bar chart (numerical x to avoid clipping)
\begin{figure}[t]
\centering
\begin{tikzpicture}
\begin{axis}[
    width=\linewidth, height=0.34\textwidth,
    ybar, ymin=0, ymax=1.0,
    ylabel={Accuracy}, ylabel style={font=\small},
    ytick={0,0.25,0.5,0.75,1.0},
    ymajorgrids, grid style={dashed,gray!25},
    xmin=0.3, xmax=4.7,
    xtick={1,2,3,4},
    xticklabels={\textsc{LLM-only},\textsc{GNN-only},\textsc{KGE} (calib.),\textsc{GNN-RAG+LLM} (ours)},
    x tick label style={font=\small,align=center},
    bar width=30pt,
    axis lines*=left,
    every axis plot/.append style={
        error bars/.cd, y dir=both, y explicit,
        error bar style={line width=0.9pt,black!55}
    },
    nodes near coords, nodes near coords style={font=\scriptsize\bfseries,
        /pgf/number format/.cd,fixed,precision=3},
]

\addplot[ybar,draw=cLLM!60!black,fill=cLLM]
    coordinates {(1,0.553) +- (0.080,0.080)};
\addplot[ybar,draw=cGNN!60!black,fill=cGNN]
    coordinates {(2,0.727) +- (0.074,0.066)};
\addplot[ybar,draw=cKGE!60!black,fill=cKGE]
    coordinates {(3,0.787) +- (0.067,0.066)};
\addplot[ybar,draw=cOurs!70!black,fill=cOurs,
         postaction={pattern=north east lines,pattern color=white}]
    coordinates {(4,0.873) +- (0.060,0.047)};

% chance reference line
\draw[dashed,red!60!black,line width=0.8pt]
    (axis cs:0.35,0.5) -- (axis cs:4.65,0.5);
\node[red!65!black,font=\scriptsize,fill=white,inner sep=1pt]
    at (axis cs:0.75,0.5) {chance};
\end{axis}
\end{tikzpicture}
